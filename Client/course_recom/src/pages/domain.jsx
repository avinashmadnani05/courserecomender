...
const UserInput = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Save user input
      await axios.post('http://localhost:3000/domain', { // Updated URL
        userId,
        interests,
        pastExperience,
        skills,
      ...
      const response = await axios.get(`http://localhost:3000/getdomain/${userId}`); // Updated URL
  ...
  return (
    <div>
      <div style={{ width: '300px', height: '300px', margin: '0 auto' }}> {/* Adjust width and height here */}
